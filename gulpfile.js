/* Gulp Build file for Project 4 - Udacity FEND
 ...
 */
var paths= {
  css: ['./css/**/*.css','./views/css/**/*.css'],
  js: ['./js/**/*.js', './views/js/**/*.js'],
  html:['./*.html', './views/*.html'],
  images: ['./img/**/*.+(png|jpg|jpeg|gif|svg)', './views/images/**/*.+(png|jpg|jpeg|gif|svg)'],
  extras: ['./*.+(md|ico)', './CNAME'],
  output: './dist/'
};
